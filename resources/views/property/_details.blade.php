...
<form action="{{ route('admin.properties.update', $property->id) }}" method="POST">
    ...
    <div class="row">
        ...
        <div class="col-md-4 mb-3">
            ...
            <input type="number" name="parking" class="form-control" value="{{ old('parking', $property->parking) }}">
        </div>
    ...
    <div class="mb-3">
        ...
        <textarea name="short_description" rows="3" class="form-control">{{ old('short_description', $property->short_description) }}</textarea>
    ...
    <div class="mb-3">
        ...
        <textarea name="description" rows="8" class="form-control">{{ old('description', $property->description) }}</textarea>
